...
output_dir="/home/zhangshaoxing/wzx/code/Videollava/output/MSVD_QA_VCD_test/tem0-vcd/${CKPT_NAME}"
video_mask_dir="/home/zhangshaoxing/wzx/datasets/MSVD_QA/sam2_addmaskblack_result"
